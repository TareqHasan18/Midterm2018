...
/**
	...
	public static void main(String[] args) throws Exception{
		...
		String vision = "Be a unique place to work where people are inspired and motivated to be the best they can be.";

		EmployeeInfo employee1 = new EmployeeInfo("Mr. Shams", 101);
		EmployeeInfo employee2 = new EmployeeInfo("Mr. Riad", 102);
		EmployeeInfo employee3 = new EmployeeInfo("Mr. Rifat", 103);
		EmployeeInfo employee4 = new EmployeeInfo("Mr. Ahmed", 104);
		EmployeeInfo employee5 = new EmployeeInfo("Mr. Nasir", 105);
